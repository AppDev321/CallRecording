...
import com.example.callrecording.databinding.FragmentIncomingBinding
import com.example.callrecording.viewmodel.DashboardViewModel
...
class IncomingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        lifecycleScope.launch {
            ...
            MyApplication.repository.incomingPhoneCallFlowList.collect{
